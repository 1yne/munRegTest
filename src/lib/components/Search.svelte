...
<button
	...
	class={`searchBorder flex h-12 items-center rounded-3xl border border-white/35 px-6 py-2 transition-all hover:border-[#D60202] ${active ? '!items-end !border-white !px-0 !py-4 !pb-0' : ''}`}
>
