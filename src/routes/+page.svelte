...
<div class="h-full">
	<div class="flex h-1/2 flex-col justify-between p-12 pt-20 text-black mobile:p-6">
		<h1 id="title" class="flex justify-center font-nyghtSerif leading-none mobile:hidden">
			RoMUN 2025
		</h1>
		...
		<div class="flex w-full justify-between">
			<h2 class="font-montserrat text-lg mobile:text-sm">25-26 October 2025</h2>
			<h2 class="font-montserrat text-lg mobile:text-sm">RCIS, Kalyan Nagar</h2>
		</div>
	</div>
